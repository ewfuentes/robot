...
http_archive(
  ...
  url = "https://github.com/RobotLocomotion/drake/releases/download/v1.39.0/drake-1.39.0-jammy.tar.gz",
  strip_prefix="drake",
...
http_archive(
  ...
  url = "https://github.com/RobotLocomotion/drake/releases/download/v1.39.0/drake-1.39.0-noble.tar.gz",
  strip_prefix="drake",
  build_file="@//third_party:BUILD.drake",
)
