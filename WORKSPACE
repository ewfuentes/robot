...
register_toolchains(
  "//toolchain:clang_15_toolchain_for_linux",
  "//toolchain:clang_18_toolchain_for_linux",
  "//toolchain:gcc_10_toolchain_for_linux",
  "//toolchain:gcc_11_toolchain_for_linux",
...
http_archive(
    ...
    urls = ["https://download.pytorch.org/libtorch/cu128/libtorch-cxx11-abi-shared-with-deps-2.7.0%2Bcu128.zip"],
    build_file="//third_party:BUILD.libtorch",
    sha256="d745ad11d47c9ecab3aa28dbca30612ebcf3e011f3943649445bf0fc27426e5c",
)
...
http_archive(
  ...
  build_file="//third_party:BUILD.zip_file",
  sha256 = "4e852f46c6d5d6e415c6a7ac94849e64b8196b3e8199f272b24bf8db275ea22d"
)
