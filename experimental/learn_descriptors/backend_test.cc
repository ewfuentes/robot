...
TEST(BackendTest, cube) {
    ...
    //         std::pair<gtsam::PinholeCamera<gtsam::Cal3_S2>, cv::Size>(cameras[i - 1], img_size),
    //         std::pair<gtsam::PinholeCamera<gtsam::Cal3_S2>, cv::Size>(cameras[i], img_size)};
    // std::vector<std::pair<SpatialTestScene::ProjectedPoint,
