...
def cfg(**overrides):
    base = tb.TrackBuilderConfig(window_px=WIN, patience_keyframes=3,
                                 drift_patience=2, min_mask_area_px=10)
...
class MaskHealthTest(unittest.TestCase):
    def test_clean_mask_passes(self):
        ...
        health = tb.mask_health(mask, [95, 95, 145, 205],
                                tb.TrackBuilderConfig())
    ...
    def test_fragmented_mask_fails(self):
        ...
        health = tb.mask_health(mask, [20, 20, 224, 224],
                                tb.TrackBuilderConfig())
    ...
    def test_spilled_mask_fails(self):
        ...
        health = tb.mask_health(mask, [150, 150, 200, 200],
                                tb.TrackBuilderConfig())
        self.assertFalse(health["ok"])
