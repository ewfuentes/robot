    ...
    def test_polar_position_embedding_basic(self):
        ...
        relative_positions = torch.tensor([
            [[[0.0, 0.0]],   # origin
             ...
             [[5.0, 0.0]]],  # distance=5, heading=pi/2
            [[[1.0, 1.0]],   # distance=sqrt(2), heading=pi/4
             [[0.0, -1.0]],  # distance=1, heading=pi
             [[-1.0, -1.0]], # distance=sqrt(2), heading=5pi/4
             [[10.0, 0.0]],  # distance=10, heading=pi/2
    ...
    def test_polar_position_embedding_distance_and_heading(self):
        ...
        relative_positions = torch.tensor([
            [[[0.0, 1.0]],   # East: distance=1, heading=0
             [[1.0, 0.0]],   # North: distance=1, heading=pi/2
             [[0.0, -1.0]],  # West: distance=1, heading=pi
             [[-1.0, 0.0]]]  # South: distance=1, heading=3pi/2
        ], dtype=torch.float32)
        ...
        # North (heading=pi/2): sin(pi/2*scale), cos(pi/2*scale)
