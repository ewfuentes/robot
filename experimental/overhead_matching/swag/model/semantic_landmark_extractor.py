...
""",
    # The two farfield prompts live in farfield_prompt_text.py: the
    # farfield extraction stage needs them without this module's
    # torch/openai dependency chain, and a second copy of a prompt is a
    # silent fork (every extraction run records prompt_sha256).
    'osm_tags_farfield': farfield_prompt_text.OSM_TAGS_FARFIELD,
    'osm_tags_farfield_v2': farfield_prompt_text.OSM_TAGS_FARFIELD_V2,
}
...
osm_tags_user_prompt = farfield_prompt_text.OSM_TAGS_USER_PROMPT
...
if __name__ == "__main__":
    ...
    panorama_parser.add_argument('--prompt_type', type=str, default='panorama',
                                 choices=['panorama', 'osm_tags', 'osm_tags_farfield',
                                          'osm_tags_farfield_v2'],
                                 help='Prompt type: "panorama" (natural language descriptions), "osm_tags" (structured OSM tags), or "osm_tags_farfield"/"osm_tags_farfield_v2" (OSM tags for distant landmarks; v2 constrains naming to the structure\'s own visible features)')
