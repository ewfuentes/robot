...
CONFIG_SCHEMA = {
    ...
    "localization.proposal.generator": _text(choices=("snapshot", "window_joint")),
    "localization.proposal.window_joint_keyframes": _integer(minimum=1),
    "localization.proposal.window_joint_max_tracklets": _integer(minimum=3),
    "localization.proposal.window_joint_resection_tracklets": _integer(minimum=3),
    "localization.proposal.window_joint_min_tracklets": _integer(minimum=3),
    "localization.proposal.window_joint_rms_tolerance_deg": _number(),
    "localization.proposal.window_joint_max_outlier_tracklets": _integer(),
    "localization.proposal.window_joint_max_tuples": _integer(minimum=1),
    "localization.proposal.window_joint_max_hypotheses": _integer(minimum=1),
    "localization.proposal.window_joint_temperature": _number(minimum=1e-9),
    "localization.proposal.window_joint_injection_sigma_m": _number(),
