...
class FilterIntegrationTest(unittest.TestCase):
    ...
    @staticmethod
    def _run(tables):
        cfg = scenario.symmetric_pair(max_visible_range_m=10000.0, keyframe_period_s=5.0)
    ...
    def test_modes_are_deterministic(self):
        data = scenario.generate(scenario.harbor_loop(max_visible_range_m=10000.0, keyframe_period_s=5.0))
        config = structs.FilterConfig(
