...
def compute(run_dir: Path, verify: bool = True
            ) -> tuple[AttributionCache, replay_mod.ReplayResult]:
    ...
    result = replay_mod.replay(run_dir, observer=recorder, verify=verify)
