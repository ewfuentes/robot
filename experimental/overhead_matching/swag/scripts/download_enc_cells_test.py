...
from experimental.overhead_matching.swag.scripts import download_enc_cells as dec
...
class ParseCatalogTest(unittest.TestCase):
    ...
    def test_bbox_selection_with_band_filter(self):
        ...
        self.assertEqual(
            ...
            ["US5BOSCD"])
        # Without the band filter the overlapping band-4 cell is included too.
        self.assertEqual(
...
class DownloadCellTest(unittest.TestCase):
    def test_download_unzips_and_is_idempotent(self):
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            dec.download_cell("US5BOSCD", out, force=True, fetch_fn=fake_fetch)
