...
"""Tests for the discovery-time trip clustering.
    ...
    bazel test //experimental/overhead_matching/swag/mapillary_tools:discover_tracks_test
...
from experimental.overhead_matching.swag.mapillary_tools.discover_tracks import cluster_tracks
