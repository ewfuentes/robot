...
"""Tests for the Mapbox Vector Tile decoder and tile arithmetic.
    ...
    bazel test //experimental/overhead_matching/swag/mapillary_tools:vector_tiles_test
...
from experimental.overhead_matching.swag.mapillary_tools import vector_tiles as vt
