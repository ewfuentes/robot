...
std::tuple<torch::Tensor, torch::Tensor, torch::Tensor> query_distances_cuda_wrapper(
    ...
    const torch::Tensor& point_coords, const torch::Tensor& point_to_geom, int64_t num_geometries,
    const torch::Tensor& cell_segment_indices, const torch::Tensor& cell_offsets,
    const torch::Tensor& cell_geom_indices, const torch::Tensor& cell_geom_offsets,
    const torch::Tensor& cell_point_indices, const torch::Tensor& cell_point_offsets,
    const torch::Tensor& cell_point_geom_indices, const torch::Tensor& cell_point_geom_offsets,
    const torch::Tensor& grid_origin, float cell_size, const torch::Tensor& grid_dims,
    const torch::Tensor& cell_polygon_indices, const torch::Tensor& cell_polygon_offsets,
    const torch::Tensor& polygon_segment_ranges, const torch::Tensor& polygon_geom_indices,
    const torch::Tensor& geom_ring_offsets, bool debug = false) {
    ...
    SegmentSpatialIndex seg_idx{cell_segment_indices, cell_offsets, cell_geom_indices,
                                cell_geom_offsets};
    PointSpatialIndex pt_idx{cell_point_indices, cell_point_offsets, cell_point_geom_indices,
    ...
    return query_distances_cuda(query_points, num_geometries, segments, points, poly_rings, grid,
                                seg_idx, pt_idx, poly_idx, debug);
}

PYBIND11_MODULE(spatial_distance_python, m) {
    m.doc() = "GPU-accelerated spatial distance queries with CUDA";
    m.def(
        "query_distances_cuda", &query_distances_cuda_wrapper,
        ...
        pybind11::arg("query_points"), pybind11::arg("segment_starts"),
        pybind11::arg("segment_ends"), pybind11::arg("segment_to_geom"),
        pybind11::arg("point_coords"), pybind11::arg("point_to_geom"),
        pybind11::arg("num_geometries"), pybind11::arg("cell_segment_indices"),
        pybind11::arg("cell_offsets"), pybind11::arg("cell_geom_indices"),
        pybind11::arg("cell_geom_offsets"), pybind11::arg("cell_point_indices"),
        pybind11::arg("cell_point_offsets"), pybind11::arg("cell_point_geom_indices"),
        pybind11::arg("cell_point_geom_offsets"), pybind11::arg("grid_origin"),
        pybind11::arg("cell_size"), pybind11::arg("grid_dims"),
        pybind11::arg("cell_polygon_indices"), pybind11::arg("cell_polygon_offsets"),
        pybind11::arg("polygon_segment_ranges"), pybind11::arg("polygon_geom_indices"),
        pybind11::arg("geom_ring_offsets"), pybind11::arg("debug") = false);
